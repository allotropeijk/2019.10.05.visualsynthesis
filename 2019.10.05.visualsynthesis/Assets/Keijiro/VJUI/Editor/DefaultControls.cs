...
namespace Klak.VJUI
{
    public static class DefaultControls
    {
        ...
        public static void SetDefaultColorTransitionValues(Selectable selectable, bool whiteOnPress)
        {
        ...
        public static void FitToParent(GameObject go, Vector2 offset)
        {
